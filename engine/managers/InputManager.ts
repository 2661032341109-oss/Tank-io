...
export class InputManager {
  ...
  public getAimVector(playerPos: Vector2, cameraOffset: Vector2): { x: number, y: number, active: boolean } {
      ...
      // Note: This needs the current camera transform to be perfectly accurate, 
      // but PlayerController handles the Mouse -> World conversion.
      // This method purely indicates if we have a direct vector override.
